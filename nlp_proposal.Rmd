---
title: "Exploratory analysis on predictive texting solution"
...
# as.numeric(no_of_lines)/sum(as.numeric(no_of_lines))
# 
# sum(as.numeric(no_of_lines))*.05
# 
# sum(as.numeric(no_of_lines))
# 
# length(lines[[1]])
# 
# total_size
...
2-g terms. For sample size `r sample_size`, it took `r time_taken_freq_terms` to 
generate frequent terms and `r time_taken_2g` for 2-g terms respectively.
